...
const Box = ({ qoutes, onclick }) => {
  return (
    <div role="main" className="p-6 font-container relative justify-center mt-60 w-4/5 bg-darkGrayishBlue mx-auto flex flex-col items-center rounded-xl  md:w-2/6">
      <div>
